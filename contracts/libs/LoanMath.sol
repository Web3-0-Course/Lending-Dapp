...
library LoanMath {
    ...
    function getRepaymentNumber(
        ...
        uint128 duration ) view internal returns ( uint256 repaymentNumber ) {
    ...
    function calculateTotalRepaymentAmount(uint256 principal,uint256 interestRate, uint256 platformFeeRate, uint256 duration) pure internal returns (uint256) {
    ...
    function getPlatformFeeAmount( uint256 principal, uint256 platformFeeRate ) pure internal returns (uint256) {
